                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
							<form method="POST" name="form_edit">
								...
								<p><strong><i class="fas fa-clock"></i>&nbsp;&nbsp;Última edição:&nbsp;</strong><?php echo formata_data_banco_com_hora($categoria->categoria_data_alteracao) ?></p>
								...
								<fieldset class="mb-3 border p-2">
									...
									<div class="form-group row mb-4">
										...
										<div class="col-md-8">
											...
											<input type="text" class="form-control" name="categoria_nome" aria-describedby="emailHelp" placeholder="Nome da categoria" value="<?php echo $categoria->categoria_nome; ?>" >
