							...
							<form method="POST" name="form_edit">
								...
								<fieldset class="mb-3 border p-2">
									...
									<div class="form-group row mb-4">
										...
										<div class="col-md-6">
											...
											<input type="text" class="form-control" name="fornecedor_razao" aria-describedby="emailHelp" placeholder="Razão social" value="<?php echo $fornecedor->fornecedor_razao; ?>" >
									...
									<div class="form-group row mb-4">
										...
										<div class="col-md-4">
											<label>CNPJ</label>
											<input type="text" class="form-control cnpj" name="fornecedor_cnpj" aria-describedby="emailHelp" placeholder="CNPJ" value="<?php echo $fornecedor->fornecedor_cnpj; ?>" >
										...
										<div class="col-md-4">
											...
											<input type="text" class="form-control" name="fornecedor_ie" aria-describedby="emailHelp" placeholder="Inscrição estadual" value="<?php echo $fornecedor->fornecedor_ie; ?>" >
									...
									<div class="form-group row mb-4">
										...
										<div class="col-md-4">
											<label>E-mail</label>
											<input type="email" class="form-control" name="fornecedor_email" aria-describedby="emailHelp" placeholder="E-mail" value="<?php echo $fornecedor->fornecedor_email; ?>" >
								...
								<fieldset class="mb-3 border p-2">
									...
									<div class="form-group row mb-3">
										...
										<div class="col-md-3">
											...
											<div class="input-group">
												<input id="cep" type="text" class="form-control cep" name="fornecedor_cep" aria-describedby="emailHelp" placeholder="CEP" value="<?php echo $fornecedor->fornecedor_cep; ?>" aria-describedby="button-addon2">
										...
										<div class="col-md-4">
											...
											<input type="text" class="form-control" name="fornecedor_endereco" placeholder="Endereço" value="<?php echo $fornecedor->fornecedor_endereco; ?>" id="endereco"/>
									...
									<div class="form-group row mb-3">
										...
										<div class="col-md-6">
											<label>Bairro</label>
											<input type="text" class="form-control" name="fornecedor_bairro" placeholder="Bairro" value="<?php echo $fornecedor->fornecedor_bairro; ?>" id="bairro"/>
										...
										<div class="col-md-4">
											<label>Cidade</label>
											<input type="text" class="form-control" name="fornecedor_cidade" placeholder="Cidade" value="<?php echo $fornecedor->fornecedor_cidade; ?>" id="cidade"/>
										...
										<div class="col-md-2">
											<label>UF</label>
											<input type="text" class="form-control" name="fornecedor_estado" placeholder="UF" value="<?php echo $fornecedor->fornecedor_estado; ?>" id="uf"/>
