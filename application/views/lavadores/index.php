				...
				<?php unset($_SESSION['error']); endif; ?>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a title="Cadastrar novo lavador" href="<?php echo base_url('lavadores/add') ?>" class="btn btn-success float-right"><i class="fas fa-hands-wash"></i>&nbsp;Novo</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php 
													echo ($lavador->lavador_tipo == 1 ? 'Pessoa Física' : 'Pessoa Jurídica' ) 
												?></td>
											...
											<td class="text-right">
												<a title="Editar usuário" href="<?php echo base_url('lavadores/edit/'.$lavador->lavador_id) ?>" class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
												<a title="Excluir usuário" href="javascript(void)" data-toggle="modal" data-target="#lavador-<?php echo $lavador->lavador_id; ?>" class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
											</td>
                                        </tr>
