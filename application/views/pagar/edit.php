                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
							<form class="user" method="POST" name="form_edit">
								...
								<fieldset class="mb-3 border p-2">
									...
									<div class="form-group row mb-4">
										...
										<div class="col-md-4">
											...
											<select class=" custom-select form-control contas_pagar" name="conta_pagar_fornecedor_id">
										...
										<div class="col-md-2">
											...
											<select class="form-control custom-select" name="conta_pagar_status">
								...
								<button type="submit" class="btn btn-primary btn mr-2" <?php echo ($conta_pagar->conta_pagar_status == 1 ? 'disabled' : '') ?>><?php echo ($conta_pagar->conta_pagar_status == 1 ? 'Conta paga' : 'Salvar') ?></button>
